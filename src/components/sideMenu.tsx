    ...
    return (
      <nav className="w-16 h-screen bg-black text-white p-3 border-r border-gray-700">
        ...
        <ul className="space-y-10">
          <li>
            <Link className={`ml-auto ${homeIsActive ? 'text-blue-600 shadow-glow' : 'text-white'}`} href="/">
          ...
          <li>
            <Link className={`ml-auto ${bookmarkIsActive ? 'text-blue-600 shadow-glow' : 'text-white'}`} href="/bookmarks">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
          ...
          <li>
            <Link className={`ml-auto ${profileIsActive ? 'text-blue-600 shadow-glow' : 'text-white'}`} href="/profile">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
